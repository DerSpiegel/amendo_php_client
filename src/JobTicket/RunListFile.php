...
class RunListFile extends PropertyList
{
     ...
     * @param DOMElement RunList element to add file to.
     */
    protected function __construct(
            string $url, string $type, DOMElement $runListElement)
    {
        $this->url = $url;
        $this->type = $type;
    ...
    public static function createFile(
            string $path, DOMElement $runListElement): self
    {
    ...
    public static function createUri(
            string $uri, DOMElement $runListElement): self
    {
